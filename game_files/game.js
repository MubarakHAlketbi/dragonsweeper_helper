        ...
        if(pushed.isMonster)
        {
            ...
            if(!pushed.defeated)
            {
                ...
                if(state.player.hp > 0)
                {
                    ...
                    // Emit monster defeated event using postMessage
                    if (window.parent !== window) {
                        // Get clean monster type name
                        let monsterType = '';
                        switch(pushed.id) {
                            case ActorId.Rat: monsterType = 'rat'; break;
                            case ActorId.Bat: monsterType = 'bat'; break;
                            case ActorId.Skeleton: monsterType = 'skeleton'; break;
                            case ActorId.Gargoyle: monsterType = 'gargoyle'; break;
                            case ActorId.Slime: monsterType = 'slime'; break;
                            case ActorId.Snake: monsterType = 'snake'; break;
                            case ActorId.Minotaur: monsterType = 'minotaur'; break;
                            case ActorId.Elemental: monsterType = 'elemental'; break;
                            case ActorId.Minion: monsterType = 'minion'; break;
                            case ActorId.Mimic: monsterType = 'mimic'; break;
                            case ActorId.Lich: monsterType = 'lich'; break;
                            case ActorId.Dragon: monsterType = 'dragon'; break;
                            case ActorId.Mine: monsterType = 'mine'; break;
                            default: monsterType = 'unknown';
                        }
